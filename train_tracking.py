...
def one_sample_step(input_dict, model, optimizer, train=True):
    ...
    centerness_mask = utils.getmaskPC_train(PC=center_xyz,maxi=input_dict['maxi_xyz'],mini=input_dict['mini_xyz']).cuda()
    ...
    return {
        ...
        'loss_reg' : loss_reg,
        'loss_box' : loss_box,
        'loss_objective' : loss_objective_focal,
        'loss' : loss
    }
